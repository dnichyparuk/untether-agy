...
| `print_timeout` | string | `15m` | Pass `--print-timeout <dur>`. Untether defaults to `15m` to override agy's own `5m0s`, which otherwise cuts off long runs. Use Go duration syntax, e.g. `"30m"`. |
